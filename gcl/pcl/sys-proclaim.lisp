...
(PROCLAIM
 '(FTYPE
   ...
   ITERATE::MV-SETQ PCL:FUNCALLABLE-STANDARD-INSTANCE-ACCESS
   ...
   SLOT-ACCESSOR-NAME::|PCL SLOTS slot WRITER| SLOT-MAKUNBOUND
   SLOT-BOUNDP
...
(PROCLAIM
 '(FTYPE
   (FUNCTION ((T) &REST T) (VALUES &REST T)) PCL:ENSURE-CLASS
   ...
   PCL::GET-FUNCTION ALLOCATE-INSTANCE REINITIALIZE-INSTANCE
   MAKE-INSTANCE ENSURE-GENERIC-FUNCTION INITIALIZE-INSTANCE
   MAKE-LOAD-FORM)) 
(PROCLAIM
 '(FTYPE
...
(PROCLAIM
 '(FTYPE
   ...
   WALKER::WALK-DECLARATIONS PCL::GET-METHOD
   PCL::GET-SECONDARY-DISPATCH-FUNCTION FIND-METHOD)) 
(PROCLAIM
 '(FTYPE
...
(PROCLAIM
 '(FTYPE
   ...
   PCL:WRITER-METHOD-CLASS PCL:READER-METHOD-CLASS
   PCL::SLOT-VALUE-OR-DEFAULT PCL::MAKE-EFFECTIVE-METHOD-FUNCTION
   PCL::GET-EFFECTIVE-METHOD-FUNCTION
   PCL::COMPUTE-SECONDARY-DISPATCH-FUNCTION WALKER:NESTED-WALK-FORM
   PCL::SYMBOL-APPEND PCL::LOAD-DEFGENERIC CHANGE-CLASS NO-NEXT-METHOD
...
(PROCLAIM
 '(FTYPE
   (FUNCTION ((T)) (VALUES &REST T)) PCL:METHOD-LAMBDA-LIST
   ...
   MAKE-INSTANCES-OBSOLETE FUNCTION-KEYWORDS METHOD-QUALIFIERS)) 
(PROCLAIM
 '(FTYPE
   (FUNCTION
    ((T) (T) (T))
...
(PROCLAIM
 '(FTYPE
   ...
   PCL::EARLY-FIND-CLASS-SYMBOL PCL::INITIALIZE-METHOD-FUNCTION
   PCL::MAKE-FINAL-DFUN PCL::MAKE-SPECIALIZABLE PCL::FIND-CLASS-CELL
   PCL::FIND-CLASS-PREDICATE PCL::UPDATE-DFUN PCL::TRACE-METHOD
   PCL::SET-DFUN PCL::EARLY-METHOD-SPECIALIZERS FIND-CLASS)) 
(PROCLAIM
 '(FTYPE
...
(PROCLAIM
 '(FTYPE
   ...
   PCL:SLOT-DEFINITION-WRITERS PCL:INTERN-EQL-SPECIALIZER
   ...
   PCL:SLOT-DEFINITION-INITFORM PCL:SLOT-DEFINITION-READERS
   ...
   PCL::METHOD-FUNCTION-PLIST PCL::ECD-SOURCE CLASS-OF CLASS-NAME)) 
(PROCLAIM
 '(FTYPE
   (FUNCTION
    ((T) (T) (T) (T))
...
(PROCLAIM
 '(FTYPE
   ...
   SETF::|PCL::GENERIC-FUNCTION-DECLARATIONS| PCL:UPDATE-DEPENDENT
   PCL:GENERIC-FUNCTION-ARGUMENT-PRECEDENCE-ORDER
   PCL::REMOVE-NAMED-METHOD PCL::|PCL::TRACED-METHOD class predicate|
   PCL::USE-PACKAGE-PCL PCL::|COMMON-LISP::PATHNAME class predicate|
   ...
   SLOT-ACCESSOR-NAME::|PCL INITARGS slot BOUNDP| SLOT-UNBOUND
   ...
   SLOT-ACCESSOR-NAME::|COMPILER NO-EMIT slot READER| SLOT-MISSING
   ...
   NO-APPLICABLE-METHOD SLOT-ACCESSOR-NAME::|SYSTEM OBJECT slot READER|
...
(PROCLAIM
 '(FTYPE
   (FUNCTION ((T) (T)) (OR (SYSTEM:TRUE) (NULL)))
...
(PROCLAIM
 '(FTYPE
   ...
   PCL:REMOVE-DIRECT-SUBCLASS PCL:COMPUTE-EFFECTIVE-SLOT-DEFINITION
   PCL:REMOVE-DIRECT-METHOD PCL:VALIDATE-SUPERCLASS
   PCL:ADD-DIRECT-SUBCLASS PCL:ADD-DIRECT-METHOD PCL:ADD-DEPENDENT
   PCL:REMOVE-DEPENDENT PCL:EFFECTIVE-SLOT-DEFINITION-CLASS
   PCL:DIRECT-SLOT-DEFINITION-CLASS PCL::LEGAL-DOCUMENTATION-P
   PCL::REMOVE-BOUNDP-METHOD PCL::%NO-PRIMARY-METHOD
   ...
   PCL::SLOT-VALUE-NORMAL PCL::MAKE-INSTANCE-FUNCTION-TRAP
   PCL::REMOVE-WRITER-METHOD PCL::UPDATE-GF-DFUN PCL::INITIAL-DFUN
   PCL::REMOVE-READER-METHOD ADD-METHOD DESCRIBE-OBJECT REMOVE-METHOD
   PRINT-OBJECT COMPUTE-APPLICABLE-METHODS DOCUMENTATION SLOT-VALUE)) 
(PROCLAIM
 '(FTYPE
...
(PROCLAIM
 '(FTYPE
   ...
   PCL::EARLY-ADD-NAMED-METHOD UPDATE-INSTANCE-FOR-REDEFINED-CLASS)) 
(PROCLAIM
 '(FTYPE
